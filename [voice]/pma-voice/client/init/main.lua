...
RegisterCommand("toggleradioclicks", function(source, args, rawCommand)
    newClicks = not newClicks
end, false)
...
function playMicClicks(clickType)
	...
	if newClicks then
		...
		SendNUIMessage({
			sound = (clickType and "audio_on_old" or "audio_off_old"),
			volume = (clickType and (volumes["radio"]) or 0.05),
		})
	end
end
