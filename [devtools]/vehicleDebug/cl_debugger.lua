...
Config.AdminList = {
	...
	'discord:112004818364592128', -- ghoul
	'discord:612076706940977162', -- tommy
	'discord:267497812185448448', -- niche
}
...
function Debugger:SaveHandling()
	...
	-- post to discord
	--self:Invoke("copyText", text)
	TriggerServerEvent('vehicledebug:senddata', vehicleName, text)
end
...
RegisterKeyMapping("+vehicleDebug", "Vehicle Debugger", "keyboard", "F2")