...
Config.VATPercentage = 0 -- Visual only, it won't influence the final invoice value, change it to your country VAT value

Config.LimitDate = true -- Used to enable/disable whether we want to have the payment limit date or not

Config.LimitDateDays = 5 -- If Config.LimitDate is enabled, it is used to define the days of the deadline for payment after issuing the invoice
