...
Config.workbenches = {
     -- items
     {
          ...
          coords = vector3(-760.55, 699.62, 149.42),
          item_show_case_offset = vector3(0.0, 0.0, 1.3),
          rotation = vector3(0.0, 0.0, 130.93),
          job = {
               allowed_list = {},
               allowed_grades = {}
          },
     ...
     -- gun
     {
          ...
          coords = vector3(-181.66, 6144.23, 41.64),
          item_show_case_offset = vector3(0.0, 0.0, 1.2),
          rotation = vector3(0.0, 0.0, 132.75),
          job = {
               allowed_list = {},
               allowed_grades = {}
          },
     ...
     {
          table_model = "gr_prop_gr_bench_02b",
          coords = vector3(-2606.23, 1914.42, 160.73-1),
          item_show_case_offset = vector3(0.0, 0.0, 1.2),
          rotation = vector3(0.0, 0.0, 192.2),
          job = {
               allowed_list = {},
               allowed_grades = {}
          },
          categories = {Config.categories.attachments},
          recipes = {attachments_recipe},
          radius = 3.0
     },
     {
          table_model = "gr_prop_gr_bench_02b",
     ...
     {
          table_model = "gr_prop_gr_bench_02b",
          coords = vector3(821.73, -588.02, 59.43-1),
          item_show_case_offset = vector3(0.0, 0.0, 1.2),
          rotation = vector3(0.0, 0.0, 173.62),
          job = {
               allowed_list = {},
               allowed_grades = {}
          },
