...
RegisterNetEvent('ps-drugprocessing:ChangeTemp', function()
	if not isTempChangeU then
		QBCore.Functions.TriggerCallback('ps-drugprocessing:validate_items', function(result)
			if result then
				exports["memorygame"]:thermiteminigame(7, 3, 5, 10,function() -- success
					...
					--vector3(982.57, -145.36, -48.08)
					local x = StartScriptFire(982.57, -145.36, -48.08-1, 20, false)
					Wait(1500)
					--explosion
					AddExplosion(981.48, -145.15, -48.78+ 1, 5, 50.0, true, false, true)
					--gas
					Wait(1000)
					AddExplosion(986.09, -144.49, -47.94, 21, 50.0, true, false, false)
					AddExplosion(981.48, -145.15, -48.78+ 1, 21, 50.0, true, false, true)
					Wait(15000)
					AddExplosion(981.48, -145.15, -48.78+ 1, 21, 50.0, true, false, true)
					Wait(1000)
					AddExplosion(986.09, -144.49, -47.94, 21, 50.0, true, false, false)
