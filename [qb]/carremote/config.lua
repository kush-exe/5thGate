...
Config.HotkeyEngine       = 48   -- Sencondary Hotkey For Turning Engine On/Off
Config.SwitchDistance     = 7     -- How Close You Need To Be To Switch Connected Vehicles
Config.MaxRemoteRange     = 60    -- Set max range that the remote will work.
