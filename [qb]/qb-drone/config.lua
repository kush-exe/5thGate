Config = {
  ...
  Drones = {
    [1] = {
      label = "Police Drone",                               -- Visible text.
      name = "police_drone",                                -- Item name.
      public = false,                                         -- Can be used by anybody?
      price = 10000,                                          -- Price
      model = GetHashKey('ch_prop_casino_drone_02a'),        -- Model
      stats = {                        
        speed   = 5.0,               -- max speed multiplier
        agility = 2.0,               -- acceleration/deceleration multiplier
        range   = 2000.0,             -- range (drone display begins fading out when leaving range)
      ...
      abilities = {
        ...
        boost       = true,  -- boost
        tazer       = false,  -- tazer 
        tracker   = true,  -- explosion
      },
      restrictions = { 'police' },          -- enter job names in here (e.g: {'police','mechanic'}) to restrict the drone purchase to these jobs only, or leave it empty (e.g: {}) for no job restrictions.
