...
function SetupCryptoData(Crypto) {
    ...
    $(".crypto-action-page-wallet").html("Wallet: "+CryptoData.Portfolio+" Cryptos");
    $(".crypto-walletid").html("Wallet: "+CryptoData.WalletId);
...
$(document).on('click', '#buy-crypto', function(e){
    ...
    if ((Coins !== "") && (Price !== "")) {
        if (JPR.Phone.Data.PlayerData.money.bank >= Price) {
            $.post('https://jpr-newphone/BuyCrypto', JSON.stringify({
                Coins: Coins,
                Price: Price,
            }), function(CryptoData){
                if (CryptoData !== false) {
                    ...
                    CloseCryptoPage()
                    JPR.Phone.Data.PlayerData.money.bank = parseInt(JPR.Phone.Data.PlayerData.money.bank) - parseInt(Price);
                    JPR.Phone.Notifications.Add("settings.png", "WBank", "&#36; "+Price+",- with sucess!", "#969695", 2500);
                } else {
                    JPR.Phone.Notifications.Add("stocks.png", "Crypto", "You don't have enough money..", "#badc58", 1500);
                }
            });
        } else {
            JPR.Phone.Notifications.Add("stocks.png", "Crypto", "You don't have enough money...", "#badc58", 1500);
        ...
        JPR.Phone.Notifications.Add("stocks.png", "Crypto", "Fill in all fields!", "#badc58", 1500);
    }
});
...
$(document).on('click', '#sell-crypto', function(e){
    ...
    if ((Coins !== "") && (Price !== "")) {
        if (CryptoData.Portfolio >= parseInt(Coins)) {
            $.post('https://jpr-newphone/SellCrypto', JSON.stringify({
                Coins: Coins,
                Price: Price,
            }), function(CryptoData){
                if (CryptoData !== false) {
                    ...
                    CloseCryptoPage()
                    JPR.Phone.Data.PlayerData.money.bank = parseInt(JPR.Phone.Data.PlayerData.money.bank) + parseInt(Price);
                    JPR.Phone.Notifications.Add("settings.png", "WBank", "&#36; "+Price+",- has been added to your account!", "#969695", 2500);
                } else {
                    JPR.Phone.Notifications.Add("stocks.png", "Crypto", "You don't have enough cryptos..", "#badc58", 1500);
                }
            });
        } else {
            JPR.Phone.Notifications.Add("stocks.png", "Crypto", "You don't have enough cryptos..", "#badc58", 1500);
    ...
    if ((Coins !== "") && (WalletId !== "")) {
        if (CryptoData.Portfolio >= Coins) {
            if (WalletId !== CryptoData.WalletId) {
                $.post('https://jpr-newphone/TransferCrypto', JSON.stringify({
                    Coins: Coins,
                    WalletId: WalletId,
                }), function(CryptoData){
                    if (CryptoData == "notenough") {
                        ...
                        JPR.Phone.Notifications.Add("settings.png", "Crypto", "This ID does not exist!", "#969695", 2500);
                    } else {
                        UpdateCryptoData(CryptoData)
                        CloseCryptoPage()
                        JPR.Phone.Notifications.Add("settings.png", "Crypto", "Transferred "+Coins+",- para "+WalletId+"!", "#969695", 2500);
                    }
                });
            } else {
                JPR.Phone.Notifications.Add("settings.png", "Crypto", "You cannot transfer to yourself..", "#969695", 2500);
            }
        } else {
            JPR.Phone.Notifications.Add("stocks.png", "Crypto", "You don't have enough cryptos..", "#badc58", 1500);
        }
