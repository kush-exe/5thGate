...
CREATE TABLE IF NOT EXISTS `phone_extras` (
...
CREATE TABLE IF NOT EXISTS `phone_grupos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `citizenid` varchar(50) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `phone_olx` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `citizenid` varchar(50) DEFAULT NULL,
...
------------------------------------
------------------------------------
---IF YOU DONT HAVE player_vehicles
