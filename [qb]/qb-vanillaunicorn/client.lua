...
local stripperbitchhh = {
  --{ model="s_f_y_stripper_02", x=115.77, y=-1286.88, z=28.88, a=263.63, animation="mini@strip_club@private_dance@idle", animationName="priv_dance_idle"},
  --{ model="mp_f_deadhooker", x=107.82, y=-1291.22, z=29.25, a=256.42, animation="mini@strip_club@lap_dance@ld_girl_a_song_a_p1", animationName="ld_girl_a_song_a_p1_f"},
  --{ model="s_f_y_stripper_01", x=106.71, y=-1289.28, z=29.25, a=356.51, animation="mini@strip_club@private_dance@idle", animationName="priv_dance_idle"},
  { model="s_f_y_stripper_02", x=110.55, y=-1287.95, z=28.45, a=254.4, animation="mini@strip_club@private_dance@part1", animationName="priv_dance_p1"},
  { model="s_f_y_stripper_01", x=109.02, y=-1285.04, z=28.45, a=338.14, animation="mini@strip_club@private_dance@part1", animationName="priv_dance_p1"},
  { model="s_f_y_stripperlite", x=104.5, y=-1289.57, z=28.85, a=301.39, animation="mini@strip_club@private_dance@part1", animationName="priv_dance_p1"},
  { model="mp_f_deadhooker", x=100.81, y=-1294.59, z=29.25, a=292.77, animation="mini@strip_club@private_dance@part1", animationName="priv_dance_p1"},
  { model="a_f_m_beach_01", x=98.11, y=-1289.99, z=29.25, a=292.77, animation="mini@strip_club@private_dance@part1", animationName="priv_dance_p1"},
  { model="s_f_y_stripper_02", x=128.0, y=-1283.42, z=30.32, a=121.78, animation="mini@strip_club@private_dance@part1", animationName="priv_dance_p1"},
  { model="s_f_y_stripper_01", x=130.61, y=-1288.2, z=30.3, a=121.78, animation="mini@strip_club@private_dance@part1", animationName="priv_dance_p1"},
}
    ...
    while true do
        ...
        if distance < 2 then
            if not IsPedInAnyVehicle(PlayerPedId(), true) then
                if distance < 2 then
                    DrawText3D(111.47, -1285.92, 28.26, '~p~[E]~w~ Make It Rain (1000$)')
					if IsControlJustReleased(0, 38) then 
